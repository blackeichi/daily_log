  ...
  return (
    <div className="w-full min-h-screen max-w-200">
      <div className="mx-auto max-w-4xl space-y-6">
        {/* 한마디 응원 카드 */}
        <section className="rounded-lg bg-white shadow-lg shadow-stone-500 overflow-hidden">
          <div className="flex items-center gap-3 p-4 py-6 bg-stone-700 text-white">
          ...
          <div className="bg-white p-6 sm:p-8 border border-stone-200 flex flex-col gap-6 sm:gap-6 items-center text-sm sm:text-base">
            <p className="leading-4 sm:leading-6 whitespace-pre-line text-center">
              {message}
            </p>
          </div>
        </section>
